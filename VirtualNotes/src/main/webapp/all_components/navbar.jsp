<%@page import="com.ravi.beans.UserDetails"%>
<nav class="navbar navbar-expand-lg navbar-dark bg-custom navbar-custom">
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		...
		<%
		UserDetails us = (UserDetails) session.getAttribute("userDA");
		if (us != null) {
		%>
		<a href="#" class="btn btn-light my-2 my-sm-0 mr-3"
			data-toggle="modal" data-target="#exampleModal" type="submit"> <i
			class="fa fa-user-circle-o" aria-hidden="true"></i><%=us.getName()%>
		</a> <a href="LogoutServlet" class="btn btn-light my-2 my-sm-0" type="submit"> <i
		...
		<a href="login.jsp" class="btn btn-light my-2 my-sm-0 mr-3"
			...
			Login
		</a> <a href="register.jsp" class="btn btn-light my-2 my-sm-0"
